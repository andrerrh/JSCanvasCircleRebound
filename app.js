...
class animationFlow {
    ...
    #checkAndChangeDirection() {
        if (this.goRight && this.circleX + this.circleR >= this.cWidth) this.goRight = false, this.#changeCircleColor()
        if (!this.goRight && this.circleX - this.circleR <= 0) this.goRight = true, this.#changeCircleColor()
        if (this.goDown && this.circleY + this.circleR >= this.cHeight) this.goDown = false, this.#changeCircleColor()
        if (!this.goDown && this.circleY - this.circleR <= 0) this.goDown = true, this.#changeCircleColor()
